...
function updateLog(){
	...
	var vB1p4 = "\n --- Update - Beta 1.4 --- \n\nChapter 1:\n-Added a const option via block mutation.\n-Changed the cout and cin streams to work via mutators.\n\nChapter 3:\n-Changed the switch case statements to work via mutators.\n\nChapter 5:\n-Changed the functions to work via mutators.\n";
	
	alert(vB1p4 + vB1p3 + vB1p2 + vB1p1 + vB1p0);
}
